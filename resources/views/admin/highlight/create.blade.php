...
<h4 class="fw-bold py-1 mb-4"><span class="text-muted fw-light">Create/</span> Highlight</h4>
                ...
                <form action="/admin/highlight" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            ...
                            <a href="/admin/highlight" class="btn btn-danger px-4 me-2 float-end btn-sm">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
