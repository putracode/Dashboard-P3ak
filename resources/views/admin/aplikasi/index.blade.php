...
<div class="card p-4">
    <div class=" d-flex justify-content-between align-items-center pb-3">
        <h5 class="p-0 m-0">Aplikasi</h5>
        <a href="/admin/aplikasi/create" class="btn-sm btn-primary float-end px-4 ">Create</a>
    </div>
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="/admin/aplikasi/{{ $row->id }}" method="POST" style="display: inline">
                            @csrf
                            @method('delete')
                            <button type="submit" class="btn btn-icon btn-danger confirmdelete" data-name="Aplikasi" id="confirmbutton">
                                <svg xmlns="http://www.w3.org/2000/svg" role="img" width="1em" height="1em"
                                        viewBox="0 0 24 24">
