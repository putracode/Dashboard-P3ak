          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ Request::is('admin/highlight*') ? 'active' : '' }}">
              <a href="/admin/highlight" class="menu-link">
                ...
                <div data-i18n="Analytics">Highlight</div>
              </a>
            </li>

            <li class="menu-item {{ Request::is('admin/aplikasi*') ? 'active' : '' }}">
              <a href="/admin/aplikasi" class="menu-link">
                <i class="menu-icon tf-icons bx bx-category"></i>
                <div data-i18n="Analytics">Aplikasi</div>
              </a>
            </li>
